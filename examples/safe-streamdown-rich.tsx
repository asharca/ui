...
export default function RichMarkdownDemo() {
  ...
  return <div className="w-full max-w-3xl" data-demo="rich-markdown">
    <div className="mb-4 flex flex-wrap items-center gap-1 rounded-xl border border-border p-1" role="group" aria-label="富文本示例">
