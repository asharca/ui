...
export const Radio = forwardRef<HTMLInputElement, RadioProps>(function Radio(
  ...
  return <label htmlFor={id} className={cn('grid cursor-pointer grid-cols-[1.125rem_minmax(0,1fr)] items-start gap-x-3 text-sm has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-50', wrapperClassName)}>
    <span className="relative mt-[3px] inline-grid size-[1.125rem] place-items-center">
      ...
      <span aria-hidden="true" className="pointer-events-none absolute size-2 scale-50 rounded-full bg-primary opacity-0 peer-checked:scale-100 peer-checked:opacity-100 motion-safe:transition-[transform,opacity] motion-safe:duration-200 motion-safe:ease-[cubic-bezier(.16,1,.3,1)] forced-colors:hidden" />
    </span>
