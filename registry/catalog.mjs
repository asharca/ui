...
export const catalog = [
  ...
  entry('checkbox', 'Checkbox', '基础组件', '支持长文本、禁用与不确定状态。'),
  entry('radio', 'Radio', '基础组件', '可以自由组合的原生单选选项。'),
  entry('radio-group', 'Radio Group', '基础组件', '原生表单语义，明确的单选状态。', [], ['radio']),
  ...
  entry('tabs', 'Tabs', '基础组件', '在同一个空间里，自然切换内容。', ['radix-ui', 'motion'], [], ['tabs', 'tabs-variants']),
  entry('accordion', 'Accordion', '基础组件', '把补充信息收好，需要时再展开。', ['radix-ui', 'lucide-react', 'motion']),
  ...
  entry('data-table', 'Data Table', '数据与布局', '表头原位切换批量操作，保留排序、搜索和跨页选择。', ['@tanstack/react-table@8.21.3', 'lucide-react', 'motion'], ['checkbox', 'search-input', 'pagination', 'button'], ['data-table'], true),
  ...
  entry('safe-streamdown', 'Safe Streamdown', 'AI 组件', 'Markdown 表格、流式正文与可选 Mermaid 图表，保留源码回退。', ['react-markdown@10.1.0', 'remark-gfm@4.0.1', 'mermaid@12.0.0', 'dompurify@3.4.16', 'lucide-react'], ['rich-content-view'], ['safe-streamdown', 'safe-streamdown-rich'], true),
  ...
  entry('conversation-sidebar', 'Conversation Sidebar', 'AI 组件', '会话搜索、分组、重命名、删除和完整顺序调整。', ['lucide-react', 'motion'], ['button', 'icon-button', 'input', 'search-input', 'dialog', 'dropdown-menu']),
  entry('chat-shell', 'Chat Shell', 'AI 组件', '桌面侧栏与移动面板，组合自己的聊天工作区。', ['lucide-react'], ['icon-button'], ['chat-shell'], true),
  entry('chat-thread', 'Chat Thread', 'AI 组件', '恢复工具、思考、附件、编辑、重新生成与消息分支。', ['lucide-react'], ['chat-panel', 'button', 'textarea', 'safe-streamdown', 'tool-call-card', 'chat-composer-toolbar'], ['chat-thread', 'chat-thread-rich'], true),
