...
for (const entry of catalog) {
  ...
  if (entry.slug.startsWith('agent-')) markdown.push('', '## beUI source integration', '', 'MIT source transplanted from starc007/ui-components at 1e23f4b10a404c17d9649086cf561e152527e2de. Independent agent-* paths preserve the existing Asharca APIs. Install the complete dependency closure. Private agent-internal-* modules are not separate showcase components. No model calls or automatic external favicon fetches. Review docs/beui-agent-migration.md for mapping, compatibility, and downstream fixes.');
