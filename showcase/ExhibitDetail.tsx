...
export function ComponentPage({ id, dark, style, density, onStyleChange }: { id: string; dark: boolean; style: DesignStyle; density: DesignDensity; onStyleChange: (style: DesignStyle) => void }) {
  ...
  return <div className="ex-document ex-detail">
    ...
    <section id="preview" className="ex-playground"><Tabs className="docs-component-tabs" value={view} onValueChange={setView}>
      ...
      <TabsContent value="preview" forceMount aria-hidden={view !== 'preview'} inert={view !== 'preview'} style={view === 'preview' ? undefined : { display: 'none' }}>
